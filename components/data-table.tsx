...
const columns: ColumnDef<z.infer<typeof schema>>[] = [
  ...
  },
  {
    ...
    header: "审核人",
    cell: ({ row }) => {
      const isAssigned = row.original.reviewer !== "待分配审核人"
        ...
        <>
          ...
          <Select>
            ...
            <SelectContent align="end">
              <SelectItem value="艾迪·莱克">艾迪·莱克</SelectItem>
              <SelectItem value="贾米克·塔什普拉托夫">
                贾米克·塔什普拉托夫
              </SelectItem>
            </SelectContent>
          </Select>
      ...
      >
        ...
        <div className="flex items-center justify-between px-4">
          <div className="text-muted-foreground hidden flex-1 text-sm lg:flex">
            {table.getFilteredSelectedRowModel().rows.length} 个已选择，共{" "}
            ...
            <>
              ...
              <div className="grid gap-2">
                ...
                <div className="text-muted-foreground">
                  显示最近6个月的访问量数据。这是一些测试文本，用于测试布局。它会跨越多行并自动换行。
                </div>
              </div>
              <Separator />
            </>
